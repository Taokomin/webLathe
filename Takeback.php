...
if (!$_SESSION["UserID"]) {
    ...
    <body>
        ...
        <div class="container">
            ...
            <br>
            <div class="btn-add">
                <a type="button" class="btn btn-success" href="Insert_Takeback/Insert_Takeback.php">
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a onclick="return confirm('คุณแน่ใจหรือว่าต้องการลบรายการนี้?')" href="Delete_Takeback/Delete_Takeback.php?Takeback_id=<?php echo $values["Takeback_id"]; ?>" class='btn btn-danger'>
