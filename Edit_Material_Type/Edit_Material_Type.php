...
$sql = "SELECT * FROM material_type WHERE MaterialType_id='$MaterialType_id'";
...
<body>
    <div class="container">
        ...
        <hr>
        <form action="ProcMte.php" method="post">
            <input type="hidden" value="<?php echo $values["MaterialType_id"]; ?>" name="MaterialType_id">
            <div class="mb-3">
            ...
            <div class="mb-3">
                <label for="MaterialType_id" class="form-label">รหัสคำนำหน้าชื่อ</label>
                <input type="text" class="form-control" name="MaterialType_id" value="<?php echo $values['MaterialType_id']; ?>" readonly>
            </div>
            <div class="mb-3">
                <label for="MaterialType_name" class="form-label">คำนำหน้าชื่อ</label>
                <input type="text" class="form-control" name="MaterialType_name" value="<?php echo $values['MaterialType_name']; ?>" required>
            </div>
            <div class="modal-footer">
                <button type="submit" class="btn btn-success ml-1">แก้ไขข้อมูล </button>
                <a type="button" class="btn btn-danger  ml-1" href="..\Material_Type.php">ยกเลิก</a>
            </div>
        </form>
    </div>
