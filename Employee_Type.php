...
if (!$_SESSION["UserID"]) {
    ...
    <body>
        ...
        <div class="container">
            ...
            <br>
            <div class="btn-add">
                <a type="button" class="btn btn-success" href="Insert_Employee_Type/Insert_Employee_Type.php">
            ...
            <table id="employee_type_table" class="table table-bordered table-striped" style="width:100%">
                ...
                <tbody>
                    ...
                    $query = "SELECT * FROM employee_type ORDER BY Auto_number asc" or die("Error:");
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a onclick="return confirm('คุณแน่ใจหรือว่าต้องการลบรายการนี้?')" href="Delete_Employee_Type/Delete_Employee_Type.php?EmployeeType_id=<?php echo $values["EmployeeType_id"]; ?>" class='btn btn-danger'>
