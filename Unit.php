...
if (!$_SESSION["UserID"]) {
    ...
    <body>
        ...
        <div class="container">
            ...
            <br>
            <div class="btn-add">
                <a type="button" class="btn btn-success" href="Insert_Unit/Insert_Unit.php">
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td style="text-align: center;"><?php echo $values["Unit_id"]; ?></td>
                            <td style="text-align: center;"><?php echo $values["Unit_name"]; ?></td>
                            <td style="text-align: center;">
                                <a href="Edit_Unit/Edit_Unit.php?Unit_id=<?php echo $values["Unit_id"]; ?>" class="btn btn-primary">
                                    <iconify-icon icon="el:file-edit"></iconify-icon>
                                </a>
                                <a onclick="return confirm('คุณแน่ใจหรือว่าต้องการลบรายการนี้?')" href="Delete_Unit/Delete_Unit.php?Unit_id=<?php echo $values["Unit_id"]; ?>" class='btn btn-danger'>
