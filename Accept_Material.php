...
if (!$_SESSION["UserID"]) {
    ...
    <head>
        ...
        <title>การจัดการข้อมูลรับเข้าวัสดุและอุปกรณ์</title>
    ...
    <body>
        ...
        <div class="container">
            <br>
            <h3 class="text-center">การจัดการข้อมูลรับเข้าวัสดุและอุปกรณ์</h3>
            <br>
            <div class="btn-add">
                <a type="button" class="btn btn-success" href="Insert_Accept_Material/Insert_Accept_Material.php">
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a onclick="return confirm('คุณแน่ใจหรือว่าต้องการลบรายการนี้?')" href="Delete_Accept_Material/Delete_Accept_Material.php?AcceptMaterial_id=<?php echo $values["AcceptMaterial_id"]; ?>" class='btn btn-danger'>
                                    <iconify-icon style="width: 14px; height: 14px" icon="ant-design:delete-outlined"></iconify-icon>
                                </a>
                            </td>
                        </tr>
                    <?php
