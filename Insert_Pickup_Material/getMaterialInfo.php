...
$sql = "SELECT m.*, u.Unit_id as Counting_unit, u.Unit_name as Counting_unit_name, u2.Unit_id as Price_unit , u2.Unit_name as Price_unit_name , u.Unit_name, u2.Unit_name, mt.MaterialType_name
FROM material as m 
...
if ($result->num_rows > 0) {
  ...
  $material = array(
    ...
    'MaterialType_id' => $row['MaterialType_id'],
  );
