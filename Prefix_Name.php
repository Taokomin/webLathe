...
if (!$_SESSION["UserID"]) {
    ...
    <body>
        ...
        <div class="container">
            ...
            <br>
            <div class="btn-add">
                <a type="button" class="btn btn-success" href="Insert_Prefix_Name/Insert_Prefix_Name.php">
            ...
            <table id="name_prefix_table" class="table table-bordered table-striped" style="width:100%">
                ...
                <tbody>
                    ...
                    $query = "SELECT * FROM prefix_name ORDER BY Auto_number asc" or die("Error:");
                    ...
                    ?>
                        <tr>
                            ...
                            <td style="text-align: center;">
                                ...
                                <a onclick="return confirm('คุณแน่ใจหรือว่าต้องการลบรายการนี้?')" href="Delete_Prefix_Name/Delete_Prefix_Name.php?Prefix_id=<?php echo $values["Prefix_id"]; ?>" class='btn btn-danger'>
