...
if (!$_SESSION["UserID"]) {
    ...
    <head>
        ...
        <title>การจัดการข้อมูลการเบิกวัสดุและอุปกรณ์</title>
    ...
    <body>
        ...
        <div class="container">
            <br>
            <h3 class="text-center">การจัดการข้อมูลการเบิกวัสดุและอุปกรณ์</h3>
            <br>
            <div class="btn-add">
                <a type="button" class="btn btn-success" href="Insert_Pickup_Material/Insert_Pickup_Material.php">
                    ...
                    ?>
                        <tr>
                            ...
                            <td align="center">
                                ...
                                <a onclick="return confirm('คุณแน่ใจหรือว่าต้องการลบรายการนี้?')" href="Delete_Pickup_Material.php/Delete_Pickup_Material.php?PickupMaterial_id=<?php echo $values["PickupMaterial_id"]; ?>" class='btn btn-danger'>
