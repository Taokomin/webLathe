...
if (!$_SESSION["UserID"]) {
    ...
    <body>
        ...
        <div class="container">
            ...
            <br>
            <div class="btn-add">
                <a type="button" class="btn btn-success" href="Insert_Customer/Insert_Customer.php">
            ...
            <table id="customer_table" class="table table-bordered table-striped" style="width:100%">
                ...
                <tbody>
                    ...
                    $query = "
                        ...
                        FROM customer as c 
                        INNER JOIN  prefix_name as n ON c.Prefix_id = n.Prefix_id
                        ORDER BY n.Prefix_id asc";
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a onclick="return confirm('คุณแน่ใจหรือว่าต้องการลบรายการนี้?')" href="Delete_Prefix_Name/Delete_Prefix_Name.php?Customer_id=<?php echo $values["Customer_id"]; ?>" class='btn btn-danger'>
