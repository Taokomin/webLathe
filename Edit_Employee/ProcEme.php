...
$sql = "UPDATE employee SET  Prefix_id = '$Prefix_id',Employee_name = '$Employee_name',Employee_surname = '$Employee_surname',Employee_number = '$Employee_number',Employee_address = '$Employee_address',EmployeeType_id = '$EmployeeType_id',Employee_license = '$Employee_license' WHERE Employee_id = '$Employee_id'";
