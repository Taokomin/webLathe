...
<head>
    ...
    <title>ออกรายงานสรุปยอดขายวัสดุและอุปกรณ์</title>
    <style type="text/css">
        img {
            width: 20px;
            height: auto;
            ...
            <div class="panel custom-panel">
                <div class="panel-heading"><b>
                    ...
                    <div class="panel-body">
                        <form id="form1" name="form1" class="form-inline" method="post" action="Report_exe3.php">
                            <center>
                                ...
                                <a href="Report_exe3.php" class="btn btn-info">รีเซ็ต</a>
                                <a href="Report_exe.php" class="btn btn-danger">ย้อนกลับ</a>
                            </center>
                            <style type="text/css">
                                #printable {
                                    display: block;
