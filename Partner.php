...
if (!$_SESSION["UserID"]) {
    ...
    <body>
        ...
        <div class="container">
            ...
            <br>
            <div class="btn-add">
                <a type="button" class="btn btn-success" href="Insert_Partner/Insert_Partner.php">
            ...
            <table id="employee_type_table" class="table table-bordered table-striped" style="width:100%">
                ...
                <tbody>
                    ...
                    $query = "
                        ...
                        FROM partner as p 
                        INNER JOIN  prefix_name as n ON p.Prefix_id = n.Prefix_id
                    ...
                    ?>
                        <tr>
                            ...
                            <td style="text-align: center;">
                                ...
                                <a onclick="return confirm('คุณแน่ใจหรือว่าต้องการลบรายการนี้?')" href="Delete_Partner/Delete_Partner.php?Partner_id=<?php echo $values["Partner_id"]; ?>" class='btn btn-danger'>
