...
if (!$_SESSION["UserID"]) {
    ...
    <body>
        ...
        <div class="container">
            ...
            <br>
            <div class="btn-add">
                <a type="button" class="btn btn-success" href="Insert_Material_Type/Insert_Material_Type.php">
            ...
            <br>
            <hr>
            <table id="material_type_table" class="table table-bordered table-striped" style="width:100%">
                <thead>
                    <tr>
                        <th style="text-align: center;">ลำดับ</th>
                        <th style="text-align: center;">รหัสคำนำหน้า</th>
                        <th style="text-align: center;">ชื่อประเภทวัสดุและอุปกรณ์</th>
                ...
                <tbody>
                    ...
                    $query = "SELECT * FROM material_type ORDER BY Auto_number asc" or die("Error:");
                    $result = mysqli_query($con, $query);
                    while ($values = mysqli_fetch_assoc($result)) {
                    ?>
                        <tr>
                            <td style="text-align: center;"><?php echo $values["Auto_number"]; ?></td>
                            <td style="text-align: center;"><?php echo $values["MaterialType_id"]; ?></td>
                            <td style="text-align: center;"><?php echo $values["MaterialType_name"]; ?></td>
                            <td style="text-align: center;">
                                <a href="Edit_Material_Type/Edit_Material_Type.php?MaterialType_id=<?php echo $values["MaterialType_id"]; ?>" class="btn btn-primary">
                                    <iconify-icon icon="el:file-edit"></iconify-icon>
                                </a>
                                <a onclick="return confirm('คุณแน่ใจหรือว่าต้องการลบรายการนี้?')" href="Delete_Material_Type/Delete_Material_Type.php?MaterialType_id=<?php echo $values["MaterialType_id"]; ?>" class='btn btn-danger'>
