...
if (!$_SESSION["UserID"]) {
    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <div>
            <a style="color:white; display: flex; width: 200px; text-align: center;">
        ...
        <div class="container ">
            <div class="row">
                <div class="col">
                <a class="btn btn-warning type=" button" href="Report1.php"><iconify-icon icon="material-symbols:drive-file-move" style="color: white;" width="84" height="84"></iconify-icon></a>
                <p class="shadow-lg p-3 mb-5 bg-body rounded"style="color:black">รายงานสรุปยอดขายสินค้า</p>
                </div>
                <div class="col">
                <a class="btn btn-warning type=" button" href="Report2.php"><iconify-icon icon="material-symbols:drive-file-move" style="color: white;" width="84" height="84"></iconify-icon></a>
                <p class="shadow-lg p-3 mb-5 bg-body rounded"style="color:black">รายงานสรุปการสั่งซื้อวัสดุและอุปกรณ์</p>
                </div>
                <div class="col">
                <a class="btn btn-warning type=" button" type="button" href="Report3.php"><iconify-icon icon="material-symbols:drive-file-move" style="color: white;" width="84" height="84"></iconify-icon></a>
